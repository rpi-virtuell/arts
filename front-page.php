...
if ('on' == et_get_option('vertex_show_projects', 'on')) {
	...
	if ($et_projects_query->have_posts()) :
		?>
		<section id="home-section-projects" class="home-block et-odd home-section">
			<div class="container">
				<div class="section-title">
					<h2><?php echo esc_html(et_get_option('vertex_home_projects_title', __('Our Recent Client Projects', 'Vertex'))); ?></h2>
					<p class="section-subtitle"><?php echo esc_html(et_get_option('vertex_home_projects_description', __('Take a look at some of the most recent work that our team has created.', 'Vertex'))); ?></p>
				</div>
							...
							if ( '' != $thumb ) {
								echo '<div class="portfolio-image">';
									...
									echo '<div class="portfolio_description">';
										...
										echo '<a href="' . esc_url( get_permalink() ) . '">' . __( 'Zur Ausstellung', 'Nimble' ) . '</a>';
									echo '</div>';
